                    ...
                    <tr class="border-b border-[#F1F5F9] hover:bg-[#FAFAFA] transition-colors group">
                        ...
                        <td class="px-6 py-4 align-middle">
                            <div class="flex items-center gap-3">
                                @if($u->fotoProfile)
                                    <img src="{{ asset('storage/' . $u->fotoProfile) }}"
                                        class="w-9 h-9 rounded-full object-cover flex-shrink-0" alt="foto">
                                @else
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($u->nama ?? $u->username) }}&background=FBB45E&color=363B58"
                                        class="w-9 h-9 rounded-full object-cover flex-shrink-0" alt="foto">
                                @endif
