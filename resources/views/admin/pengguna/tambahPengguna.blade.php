...
<div class="m-5 pb-10">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <div class="flex gap-3">
            <a href="/admin/pengguna" class="flex items-center gap-2 bg-white border border-[#E2E8F0] text-[#363B58] font-bold text-sm px-5 py-2.5 rounded-[10px] no-underline hover:bg-[#F1F5F9] active:bg-[#E2E8F0] transition-colors duration-200 select-none">
                Kembali
            </a>
    ...
    <form id="form-tambah-pengguna" action="/admin/tambah-pengguna" method="POST" enctype="multipart/form-data"
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-[#F1F5F9]">
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea name="deskripsi" rows="5" placeholder="Masukkan Deskripsi Tempat Disini&#10;(maks. 300 kata)" class="border border-[#E2E8F0] rounded-xl px-4 py-3 text-sm outline-none bg-[#FAFAFA] placeholder-gray-300 resize-none focus:border-[#FBB45E] focus:ring-2 focus:ring-[#FBB45E]/20 hover:border-[#FBB45E]/50 transition-all duration-200" required></textarea>
            </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-[#F1F5F9]">
            ...
            <div id="foto-drop"
                ...
                <img id="foto-preview" src="" alt="Preview" style="display:none;" 
                     class="w-40 h-40 object-cover rounded-full border-4 border-[#FBB45E]/40 shadow-md">
