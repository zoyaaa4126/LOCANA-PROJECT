            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="bg-[#363B58] rounded-2xl p-6 shadow-sm">
                    ...
                    <div class="flex flex-col gap-3">
                        <a href="/pengguna/edit/{{ $user->id }}" class="w-full flex items-center justify-center gap-2 bg-white hover:bg-[#F1F5F9] text-[#363B58] font-bold text-sm px-5 py-3 rounded-xl transition-colors duration-200"><span class="material-symbols-outlined" style="font-size:18px;">edit</span>
                            Edit Pengguna
                        </a>
