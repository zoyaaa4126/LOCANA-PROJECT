            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-[#F1F5F9]">
                ...
                <div class="flex flex-col gap-1.5 mb-4">
                    ...
                    <div class="relative" id="kategori-wrapper">
                        <button type="button" id="kategori-btn"
                                onclick="toggleKategori()"
                                class="w-full flex justify-between items-center border border-[#E2E8F0] rounded-xl px-4 py-3 text-sm bg-[#FAFAFA] text-gray-400 focus:outline-none focus:border-[#FBB45E] transition-all">
